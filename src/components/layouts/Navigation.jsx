...
import { navigationAnimation, navigationCloseAnimation } from "../../hooks/gsapAnimations";
...
const Navigation = () => {
    ...
    const handleCloseClick = (e) => {
        navigationCloseAnimation(".navigation-animation", 0.5, el.current);
    }

    return (
        <>
            <div ref={el} className="w-[33%] flex flex-wrap justify-end relative">
                <div onClick={handleClick} className="w-[60%] text-white border-b border-op-white-25 py-3 px-4 navigation-section cursor-pointer transition duration-700 ease-in-out hover:bg-white hover:text-op-darkBlue">
