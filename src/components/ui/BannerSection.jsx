        ...
        <>
            <section id="op-banner-section" ref={el} className="relative xl:px-24 lg:px-20 md:px-16 px-8 bg-primaryColor overflow-hidden h-screen bg-soft">
                ...
                <div className="flex flex-wrap items-center justify-end content-center h-screen md:gap-8 gap-4">
                    <h1 className="text-secondaryColor font-medium xl:text-[14vw] text-[12vw] w-full leading-[normal] text-left relative z-10 branding-fade opacity-[0.01]">
                        Objective<span className="text-acentColor">Pixel</span>
                    </h1>
                    <p className="text-secondaryColor md:pt-4 pt-0 lg:text-3xl text-2xl leading-normal tagline-effect inline-block md:flex flex-wrap flex-col opacity-[0.01]">
