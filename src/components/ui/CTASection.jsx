...
const CTASection = () => {
    ...
    return (
        <section ref={el} className="op-sec-scale-zoom xl:px-24 lg:px-20 md:px-16 px-8 py-24 bg-black relative rounded-xl m-8 scale-[1] origin-top">
            <div className="flex flex-wrap items-center justify-center md:gap-16 gap-8">
                <h2 className="section-title-animation text-secondaryColor text-[8vw] text-center leading-[normal] opacity-[0.01]">No magic formula just Consistent effort.</h2>
