    ...
    return (
        <>
            <div ref={el} className="w-[33%] flex flex-wrap justify-end relative">
                <div onClick={navigationHandlerOpen} className="lg:w-[60%] w-[100%] text-secondaryColor border-none sm:border-solid border-b border-whiteColor-25 py-3 px-4 navigation-section cursor-pointer transition duration-700 ease-in-out hover:bg-secondaryColor hover:text-primaryColor">
                ...
                <div className="navigation-wrapper invisible fixed top-0 left-0 w-screen h-screen">
                    ...
                    <div className="navigation-content relative z-10 w-full h-full">
                        ...
                        <div className="navigation-socialMedia absolute bottom-6 right-6">
                            <a href="#" target="_blank" className="uppercase text-sm tracking-widest text-secondaryColor">Instagram</a>
                        </div>
