            ...
            <div ref={el} className="w-[33%] flex flex-wrap justify-end relative">
                ...
                <div className="navigation-wrapper invisible fixed top-0 left-0 w-screen h-screen">
                    ...
                    <div className="navigation-content relative z-10 w-full h-full">
                        <div className="absolute md:top-6 top-4 md:left-6 left-4">
                            <img src="https://www.mwfloridalaw.com/wp-content/uploads/2019/12/logo.png" alt="Logo" />
                        </div>
                        ...
                        <div className="main-navigation h-screen w-[89%] pl-[8vw] pt-[100px] invisible">
